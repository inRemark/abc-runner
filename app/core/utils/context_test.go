...
// NewTestAdapter 创建测试适配器
func NewTestAdapter(protocolName string) *TestAdapter {
	return &TestAdapter{
...
// Connect 实现ProtocolAdapter接口
func (t *TestAdapter) Connect(ctx context.Context, config interfaces.Config) error {
	t.config = config
	t.connected = true
	return nil
}

// Execute 实现ProtocolAdapter接口
func (t *TestAdapter) Execute(ctx context.Context, operation interfaces.Operation) (*interfaces.OperationResult, error) {
...
// Close 实现ProtocolAdapter接口
func (t *TestAdapter) Close() error {
	t.connected = false
	return nil
}

// GetProtocolMetrics 实现ProtocolAdapter接口
func (t *TestAdapter) GetProtocolMetrics() map[string]interface{} {
	return t.metrics
}

// HealthCheck 实现ProtocolAdapter接口
func (t *TestAdapter) HealthCheck(ctx context.Context) error {
	return nil
}

// GetProtocolName 实现ProtocolAdapter接口
func (t *TestAdapter) GetProtocolName() string {
	return t.protocolName
}

// GetMetricsCollector 实现ProtocolAdapter接口
func (t *TestAdapter) GetMetricsCollector() interfaces.MetricsCollector {
	return nil // 返回nil用于测试
}

// TestTestContext 测试上下文
func TestTestContext(t *testing.T) {
	adapter := NewTestAdapter("test")
	ctx := NewTestContext(adapter, nil, nil, nil)

	if ctx.GetAdapter() != adapter {
		t.Error("GetAdapter returned unexpected adapter")
	}
	...
	if ctx.GetKeyGenerator() != nil {
		t.Error("GetKeyGenerator should return nil")
	}
